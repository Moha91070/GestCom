...
import 'package:authentification/pageAuth/Inscription_auth.dart';
import 'package:authentification/pageAuth/login.dart';
        ...
        body: Center(
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Image.asset('image/867.jpg', height: 200.0, width: 300.0),
                RichText(
                  text: TextSpan(
                    text: 'Bienvenue dans\n'.toUpperCase(),
